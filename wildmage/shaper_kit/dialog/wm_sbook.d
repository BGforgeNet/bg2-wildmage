...
IF ~~ study1
  ...
  IF ~OR(4) Global("wm_book_spell","LOCALS",0) 
            ...
            Global("wm_book_spell","LOCALS",3)~ REPLY @20 GOTO 00    // -> +4 = 4,5,6,7

  IF ~OR(4) Global("wm_book_spell","LOCALS",0)  
            Global("wm_book_spell","LOCALS",1) 
            Global("wm_book_spell","LOCALS",4)
            Global("wm_book_spell","LOCALS",5)~ REPLY @21 GOTO 01    // -> +2 = 2,3,6,7

  IF ~OR(4) Global("wm_book_spell","LOCALS",0)
      Global("wm_book_spell","LOCALS",2)
      Global("wm_book_spell","LOCALS",4)
            Global("wm_book_spell","LOCALS",6)~ REPLY @22 GOTO 02    // -> +1 = 1,3,5,7

...
IF ~~ study1
  ...
  IF ~OR(2) Global("wm_book_spell","LOCALS",0) Global("wm_book_spell","LOCALS",1)~ THEN REPLY @20 GOTO 00   // -> +6 = 6/7
  IF ~OR(2) Global("wm_book_spell","LOCALS",0) Global("wm_book_spell","LOCALS",6)~ THEN REPLY @22 GOTO 02   // -> +1 = 1/7
